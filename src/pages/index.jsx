  ...
  <React.Fragment>
    ...
    <Parallax pages={5}>
      ...
      <Content speed={0.4} offset={0}>
        <Hero>
          <BigTitle>
            Hello, <br /> I'm Beng Hui.
          </BigTitle>
          <Subtitle>An aspiring full-stack web developer, occasional photographer and lifelong learner!</Subtitle>
        </Hero>
      </Content>
      <DividerMiddle
      ...
      <Content speed={0.4} offset={1.2} factor={2}>
        <Inner>
          ...
          <ProjectsWrapper>
            <ProjectCard
              title="Flappy"
              link="https://benghui.github.io/flappy/"
              bg="linear-gradient(to right, #D4145A 0%, #FBB03B 100%)"
            >
              Minimalistic flappy bird game.
            </ProjectCard>
            <ProjectCard
              title="Expense Tracker"
              link="https://expense-tracker-.herokuapp.com/"
              bg="linear-gradient(to right, #662D8C 0%, #ED1E79 100%)"
            >
              A minimalistic expense tracker app.
            </ProjectCard>
            <ProjectCard
              title="Carouhell"
              link="https://carouhell.herokuapp.com/"
              bg="linear-gradient(to right, #009245 0%, #FCEE21 100%)"
            >
              Recreation of Carousell to learn the parts of an E-commerce app.
            </ProjectCard>
            <ProjectCard
              title="Photography"
              link="https://benghui.wixsite.com/benghui"
              bg="linear-gradient(to right, #D585FF 0%, #00FFEE 100%)"
            >
              One of my first websites created using wixsite template and piqued my interest in web development.
            </ProjectCard>
          </ProjectsWrapper>
        </Inner>
      </Content>
      ...
      <Content speed={0.4} offset={3}>
        <Inner>
          ...
          <AboutHero>
            ...
            <AboutSub>
              An explorer interested in creating and building and solving problems.
            </AboutSub>
          </AboutHero>
          <AboutDesc>
